    ...
    void testPatchPerson() throws Exception {
        ...
        MockHttpServletResponse response = mockMvc
                .perform(
                        patch("/people/" + id)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\": \"BORIS\", \"lastName\": \"DONDSON\"}"))
                .andReturn()
                .getResponse();
        assertThat(response.getStatus()).isEqualTo(200);
        MockHttpServletResponse response2 = mockMvc
                ...
                .andReturn()
                .getResponse();
        assertThat(response2.getContentAsString()).contains("BORIS", "DONDSON");
        assertThat(response2.getContentAsString()).doesNotContain("Jack");
    }
    @Test
